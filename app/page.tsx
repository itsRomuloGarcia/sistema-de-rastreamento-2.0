        ...
        >
          <form onSubmit={handleSearch} className="space-y-6">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="input-field pl-12 pr-4 py-3 text-lg border-2 border-gray-300 dark:border-gray-600 focus:border-[#FFA000] transition-colors bg-white dark:bg-gray-800 text-gray-900 dark:text-white w-full rounded-lg"
                  autoComplete="off"
                  autoFocus
                />
              </div>
            ...
            <button
              ...
              className="btn-primary bg-gradient-to-r from-[#FFA000] to-[#FDB913] hover:from-[#FDB913] hover:to-[#FFA000] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 py-3 text-lg font-semibold transition-all hover:scale-105 w-full rounded-lg text-white"
            >
        ...
        <AnimatePresence mode="wait">
          {isLoading && (
            <motion.div
              ...
              className="card text-center py-12 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg"
            >
          ...
          {error && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: -20 }}
              className="card border-red-300 dark:border-red-700 bg-red-50 dark:bg-red-900/20 backdrop-blur-sm shadow-lg rounded-lg"
            >
          ...
          {searchTerm && !isLoading && !error && !tracking && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: -20 }}
              className="card border-orange-300 dark:border-orange-700 bg-orange-50 dark:bg-orange-900/20 backdrop-blur-sm shadow-lg rounded-lg"
            >
              <div className="flex items-center gap-4 p-4">
